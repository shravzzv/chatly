      ...
      <div className='w-full max-w-7xl bg-background p-8 md:p-12 rounded-2xl shadow-sm space-y-8'>
          ...
          <ul className='list-disc pl-6 space-y-2'>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to Chatly.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to Chatly, accessible from{' '}
                <Link
        ...
        <section className='prose max-w-none'>
          ...
          <p>
            ...
            and accessing subscription-only features). When you register an
          ...
          <p>
            ...
            Community Guidelines (if any). If you believe your account has been
          ...
          <p>
            Chatly allows users to create and upload content, such as text,
            images, and other materials. By uploading content you represent and
            warrant that you own the content or have the necessary rights to
            publish it and that your content does not infringe the rights of any
            third party or violate applicable law.
          </p>
          <p>
            You retain ownership of content you create and upload, but by using
            the Service you grant Chatly a worldwide, non-exclusive,
            royalty-free license to host, store, reproduce, modify, publish, and
            display your content as necessary to operate and improve the Service
            (including for caching and backup). We may also use anonymized or
            aggregated content for analytics and product improvements.
          </p>
          <p>
            Chatly reserves the right to remove, reject, or disable access to
            any content that violates these Terms or our content policies, at
          ...
          <p>
            Chatly may offer paid subscription plans that provide access to
            additional features. Pricing, trials, and subscription terms will be
            presented to you prior to purchase. Subscriptions automatically
            renew unless canceled. You are responsible for all fees and taxes
            associated with your subscription.
          </p>
          <p>
            Refunds, cancellations, and billing disputes will follow the
            procedures posted in our billing/help pages or as otherwise
            communicated at the time of purchase. We reserve the right to change
          ...
          <p>
            All content that is original to Chatly (including logos, product
            names, source code, designs, and other creative works) is the
            exclusive property of the Company and is protected by applicable
            intellectual property laws.
          </p>
          <p>
            If you submit creative content, you retain ownership of your
            submissions, but you grant Chatly the license described above for
            the operation and improvement of the Service. Your trademarks and
            brand assets remain your property.
          </p>
          <p>
            You may not use Chatly&apos;s trademarks or logos without prior
        ...
        <footer className='text-sm text-muted-foreground'>
          <p>
            ...
            user content, subscription plans, and intellectual property to
            accurately reflect Chatly&apos;s features and policies.
          </p>
        </footer>
      </div>
    </div>
