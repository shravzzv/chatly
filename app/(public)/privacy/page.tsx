    ...
    <div className='max-w-7xl mx-auto p-6 space-y-8'>
      ...
      <section className='space-y-2'>
        ...
        <ul className='list-disc list-inside space-y-1'>
          ...
          <li>
            ...
            by, or is under common control with a party (50% or more ownership).
          </li>
          <li>
          ...
          <li>
            ...
            <Link href='https://chatly-brown.vercel.app' className='underline'>
      ...
      <section className='space-y-2'>
        ...
        <ul className='list-disc list-inside space-y-1'>
          ...
          <li>
            <strong>Persistent Cookies:</strong> remain on your device offline.
          </li>
          <li>
      ...
      <section className='space-y-2'>
        ...
        <p>
          The Service does not address anyone under 13. Contact us if your child
          has provided Personal Data so we can remove it.
        </p>
      </section>
      ...
      <section className='space-y-2'>
        ...
        <p>
          We are not responsible for third-party websites. Review their privacy
          policies when visiting external links.
        </p>
      </section>
