...
function DropdownMenuSubTrigger({
  ...
  return (
    <TextClassContext.Provider
      value={cn(
        'text-sm select-none group-active:text-accent-foreground font-sans',
          ...
          <NativeOnlyAnimatedView entering={FadeIn}>
            <TextClassContext.Provider value='text-popover-foreground'>
              <DropdownMenuPrimitive.Content
                className={cn(
                  'min-w-[8rem] overflow-hidden rounded-md border border-border bg-popover p-1 font-sans shadow-lg shadow-black/5',
                  Platform.select({
                    web: cn(
...
function DropdownMenuItem({
  ...
  return (
    <TextClassContext.Provider
      value={cn(
        'select-none text-sm text-popover-foreground group-active:text-popover-foreground font-sans',
        variant === 'destructive' &&
