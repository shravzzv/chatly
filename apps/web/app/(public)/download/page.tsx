    ...
    <div className='space-y-8 p-8'>
      ...
      <div className='space-y-2'>
        ...
        <p>
          Click this{' '}
          <Link
            href='https://github.com/shravzzv/chatly/releases/download/v1.1.0/chatly.apk'
            download
            className='underline underline-offset-2'
          >
            link
          </Link>{' '}
          or scan this QR to install the android app.
        </p>
        <Image
          src={qr}
          alt='android download qr code'
          className='size-48 rounded-sm shadow-lg'
        />
      </div>
    </div>
  )
